  ...
  return (
    <div className='content'>
      ...
      <div className="userInfo">
        <img src="path_to_headshot.jpg" alt="User Headshot" className="headshot"/>
        <p>Name: John Doe</p>
        <p>Surname: Smith</p>
      ...
      <button onClick={() => setShowAllGames(!showAllGames)}>Past MBB Games</button>
      {showAllGames && (
        <ul>
          {pastGames.map(game => (
      ...
      <button onClick={() => setShowAttendedGames(!showAttendedGames)}>Attended MBB Games</button>
      {showAttendedGames && (
        <ul>
